    ...
    <div className="min-h-screen bg-background py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto space-y-10">
        ...
        {loading ? (
          ...
          <div className="bg-card border border-border rounded-3xl p-16 text-center space-y-4 max-w-md mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {posts.map((post) => {
              ...
              return (
                <div
                  key={post._id}
                  className="bg-card border border-border rounded-3xl overflow-hidden shadow-sm hover:shadow-xl hover:border-cyan-500/30 transition-all duration-300 flex flex-col justify-between group">
                  <div>
                  ...
                  <div className="p-6 pt-0 flex items-center justify-between border-t border-border/50 mt-4 pt-4 text-xs">
                    ...
                    <Button
                      ...
                      href={`/forum/${post._id}`}
                      size="sm"
                      className="bg-gradient-to-r from-blue-600 to-cyan-500 text-white font-bold shadow-md hover:from-blue-700 hover:to-cyan-600 rounded-xl"
                      endContent={<FaArrowRight className="h-3 w-3" />}>
                      Read More
                    </Button>
                  </div>
                </div>
